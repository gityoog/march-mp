...
const testProxy = new Proxy(Object.defineProperty({}, 'isLowVersion', { value: '', enumerable: false }), { ownKeys: target => Object.getOwnPropertyNames(target) })
const isLowVersion = Object.keys(testProxy).includes('isLowVersion') || getKeys(testProxy).includes('isLowVersion')
