...
var MPEntryPlugin = /** @class */ (function () {
    function MPEntryPlugin(options) {
        if (options === void 0) { options = {}; }
        this.options = options;
        this.name = 'MPEntryPlugin';
        this.manager = new manager_1.default;
    }
    MPEntryPlugin.prototype.ignore = function (page) {
        var _a;
        return (_a = this.options.ignore) === null || _a === void 0 ? void 0 : _a.some(function (item) {
    ...
    MPEntryPlugin.prototype.apply = function (compiler) {
        ...
        if (this.options.ignore && this.options.ignore.length > 0) {
            appjsonData.pages = (_a = appjsonData.pages) === null || _a === void 0 ? void 0 : _a.filter(function (page) { return !_this.ignore(page); });
            (_b = appjsonData.subpackages) === null || _b === void 0 ? void 0 : _b.forEach(function (_a) {
                var root = _a.root, pages = _a.pages;
                pages = pages.filter(function (page) { return !_this.ignore(root + '/' + page); });
            });
        }
